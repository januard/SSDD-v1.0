                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="pt-3 pb-5">
                                <label>Style</label>
                                <div>
                                    <button type="button" class="btn btn-prmry element" data-group="g1" data-element="e1">DEFAULT</button>
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0)" class="d-none g1" data-toggle="dropdown"></a>
                                            <div class="dropdown-menu">
                                                <a href="javascript:void(0)" class="dropdown-item" data-category="react">Copy React Code</a>
                                                <a href="javascript:void(0)" class="dropdown-item" data-category="html">Copy HTML Code</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
