                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>Default (Administrator, Staff)</small>
                                @error('account_type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="portal" class="col-md-4 col-form-label text-md-right">{{ __('Portal') }}</label>

                            <div class="col-md-6">
                                <input id="portal" type="text" class="form-control @error('portal') is-invalid @enderror" name="portal" value="{{ old('portal') }}" required autocomplete="portal" autofocus>
                                <small>For the meantime (COD, VDD, WRD, SPD, ADMIN)</small>
